...
const CatalogPage = () => {
    return (
        <section className="flex w-full flex-wrap items-center justify-between  py-2 px-3 text-gray-900 text-sm font-semibold">
            <Link href={"/deals"} className=" flex flex-col justify-center items-center gap-1">
                <div className=" flex justify-center items-center transition-all w-16 h-16 bg-orange-100 rounded-md hover:bg-orange-200  dark:bg-orange-100 dark:text-orange-700">
