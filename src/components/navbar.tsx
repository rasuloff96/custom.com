    ...
    <header className=" flex items-center px-4 flex-wrap  md:px-12 py-2 justify-between fixed top-0 w-full z-50 shadow bg-white dark:bg-gray-900 dark:text-white">
      ...
      <form className="w-2/4">
        ...
        <div className="relative">
          ...
          <input type="search" id="default-search" className="block w-full h-10 p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-full outline-none bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required />
        </div>
      </form>
